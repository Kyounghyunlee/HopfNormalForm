...
Uf=Continuation.Hopf_point(Continuation.flutter_eq_RSPA_model1, [18.0]) #Compute the Hopf point
...
b,a,ρ,x_α,c_α,c_h,I_α,k_α,k_h,m,m_T=Continuation.set_params_1()
model=Continuation.RSPA_model(Continuation.set_params_1(),U)
J=model.J
M2=model.M2
